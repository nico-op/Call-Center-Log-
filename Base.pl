...
causas_db(computadora, [
        ...
        ['El cable de red esta dañado'], %Causa5
        ...
        ['La tarjeta de red esta dañada']%Causa12
        ]).
...
respuestas(computadora, [
        ...
        ['Contacte a su compañia'], %Solucion11
        ['Restablezca la configuracion predeterminada del antivirus o reinstale el antivirus'], %Solucion12
        ['Si cambio la configuracion, restablezca la configuración predeterminada'] %Solucion13
 ]).
